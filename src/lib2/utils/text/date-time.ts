import { isThisYear, isToday } from '~/lib2/utils/datetime/same-date';
import { memoizeLast } from '~/lib2/utils/memoize/memoize-last';
import { DEFAULT_LOCALE } from '~/lib2/utils/text/default-locale';
import { getT } from '~/lib2/utils/text/t-tag';
...
function formatDateTimeWithWeekday(dateTime: Date | number, locale?: string) {
	const t = getT(locale ?? DEFAULT_LOCALE);
