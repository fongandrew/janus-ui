...
|---|---|---|---|
| `o-box` | block-mode | `--o-box__radius`; writes `--o-box__radius-inner` for a box nested in it (§8.2) | Default container. Uniform block padding, nesting-math inline padding. Use when contents are other components or rows. One nested level rounds one step down automatically. |
